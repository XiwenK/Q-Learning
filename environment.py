...
class CliffBoxPushingBase:
    ...
    def __init__(self,
                 ...
                 obs_size=3,
                 reward_goal=0,
                 reward_agent_box_distance=True,
                 # enable reward for agent and box distance. DO NOT set False, else it will be very hard
                 reward_box_goal_distance=True,
                 # enable reward for box and goal distance. DO NOT set False, else it will be very hard
